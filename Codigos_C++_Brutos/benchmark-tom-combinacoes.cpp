...
int main() {
    ...
    cout << "Combinacoes processadas com sucesso: " << total_calculado << endl;
    cout << "Tempo total de execucao: " << duracao << " milissegundos" << endl;
    cout << "Velocidade: " << (total_calculado / (duracao ? duracao : 1)) * 1000 << " combinacoes por segundo." << endl;
