...
int main() { 
    ...
    std::cout << "Tempo total gasto de fibonacci: " << duracao.count() << " milissegundos.\n";

    std::cout << "Tempo total gasto em segundos de fibonacci: " << std::chrono::duration_cast<std::chrono::duration<double>>(duracao).count() << "s.\n";
